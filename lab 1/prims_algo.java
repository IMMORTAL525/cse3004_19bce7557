...
import java.util.*; 
import java.io.*; 
class Main {  private static final int countOfVertices = 9; 
 ...
 if (graphArray[edge][vertex] != 0 && setOfMST[vertex] == false && graphArray[edge][vertex] < keys[vertex]) {  mstArray[vertex] = edge;  keys[vertex] = graphArray[edge][vertex]; 
 } 
 } 
 ...
 Main mst = new Main(); 
 int graphArray[][] = new int[][]{{ 0, 4, 0, 0, 4, 0, 6, 8, 0 }, 
 { 4, 0, 8, 0, 0, 0, 0, 11, 0 }, 
 { 0, 8, 0, 7, 0, 4, 0, 0, 2 }, 
 { 0, 0, 7, 1, 9, 14, 0, 0, 0 }, 
 { 5, 0, 0, 9, 0, 10, 0, 0, 0 }, 
